...
public class Test16 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(4000);
		driver.findElement(By.name("username")).sendKeys("harivardan");
		Thread.sleep(2500);
		...
		{
			System.out.println("Test Successful - Check Incorrect Credentials");
		}
		else
		{
			System.out.println("Test Failure - Check Correct Credentials");
		}
		driver.close();
	}
